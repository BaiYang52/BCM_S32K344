...
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_AppRunTask_0_10ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
...
{
  OS_ALARM_CASTCONFIG_ALARMACTIVATETASK_2_ALARM(OsCfg_Alarm_Rte_Al_TE2_AppRunTask_0_10ms),
  NULL_PTR
};
