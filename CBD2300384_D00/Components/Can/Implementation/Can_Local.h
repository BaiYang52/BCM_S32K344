...
# define CanRxActualDLC(rxStruct)          CAN_DLC2LEN((vuint8)((((tCanRxMsgBufferPtr)((rxStruct)->pChipMsgObj))->control_ts) >> 16) & (vuint8)0x0F)
# define CanRxActualIdType(rxStruct)       ((vuint8)((((tCanRxMsgBufferPtr)((rxStruct)->pChipMsgObj))->control_ts) >> 16) & (vuint8)kCanIdTypeExt)
# define CanRxActualFdType(rxStruct)       ((((tCanRxMsgBufferPtr)((rxStruct)->pChipMsgObj))->control_ts >> 16) & kCanFdTypeFd)
#else
...
#define CanTxActualData(txStruct, i)       ((vuint8)((txStruct)->pChipData[(i)]))
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanTxActualDLC(txStruct)          CAN_DLC2LEN((vuint8)((((tCanMsgObjPtr)((txStruct)->pChipMsgObj))->control_ts) >> 16) & (vuint8)0x0Fu)
# define CanTxActualIdType(txStruct)       ((vuint8)((((tCanMsgObjPtr)((txStruct)->pChipMsgObj))->control_ts) >> 16) & (vuint8)kCanIdTypeExt)
# define CanTxActualFdType(txStruct)       ((((tCanMsgObjPtr)((txStruct)->pChipMsgObj))->control_ts >> 16) & kCanFdTypeFd)
#else
...
#  define CanTxWriteActId(txStruct, id)       (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = MK_STDID0(id); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts) &= (vuint32)0xFF0F0000u

#  define CanTxWriteActFdId(txStruct, id)     (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = MK_STDID0(id); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts)  |= (vuint32)((vuint16)kCanFdTypeFd | (vuint16)kCanFdBrsTypeTrue) << 16; \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts) &= (vuint16)0xFF0F0000u

#  define CanTxWriteActExtId(txStruct, id)    (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = MK_EXTID0(id); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts) |= (vuint32)kCanIdTypeExt << 16)

#  define CanTxWriteActFdExtId(txStruct, id)  (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = MK_STDID0(id); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts)  |= (vuint32)((vuint16)kCanIdTypeExt | (vuint16)kCanFdTypeFd | (vuint16)kCanFdBrsTypeTrue) << 16;
# else
#  define CanTxWriteActId(txStruct, id)       (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = MK_STDID0(id); \
...
#  define CanTxWriteActFdId(txStruct, id)    (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = ((((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) & 0x0000FFFFu) | ((vuint32)MK_STDID0(id) << 16); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts)  |= (vuint32)kCanFdTyp << 16;
# else
#  define CanTxWriteActId(txStruct, id)       (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) = ((((tCanMsgObjPtr)((txStruct).pChipMsgObj))->msgID) & 0x0000FFFFu) | ((vuint32)MK_STDID0(id) << 16); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control) &= (vuint16)0xFF0Fu
...
#endif
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanTxWriteActDLC(txStruct, dlc)     (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts) &= (vuint32)((vuint32)kCanIdTypeExt | (vuint32)0xFF000000) << 16); \
                                            (((tCanMsgObjPtr)((txStruct).pChipMsgObj))->control_ts) |= (vuint32)(((vuint8)(dlc) & (vuint8)0x0Fu) << 16)
#else
...
***********************************************************************************************************/
/* CODE CATEGORY 4 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_WriteProtectedReg32(CAN_CHANNEL_CANTYPE_FIRST vuint16 area, CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara);
/* CODE CATEGORY 4 END */
# endif
