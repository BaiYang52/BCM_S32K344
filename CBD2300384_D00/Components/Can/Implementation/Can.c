...
/* PRQA S 3238,3240,3242 EOF */ /* MD_Can_InlineExternalLinkage */
...
#define kFlexCAN_MAXMB     ((vuint16)0x007Fu)       /*!< Maximum Number of Message Buffers: maximum number of used message buffers = MAXMB+1 */

#if defined (C_ENABLE_REGISTER_32BIT_ACCESS) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
/* Bitmasks of FlexCAN module configuration register CANx_MCR (32 bit register access */
# define kFlexCAN_MDIS_32      ((vuint32)0x80000000u)       /*!< Module Disable: shut down FlexCAN clocks */
# define kFlexCAN_FRZ_32       ((vuint32)0x40000000u)       /*!< Freeze Enable: allow entering the freeze mode */
# define kFlexCAN_FEN_32       ((vuint32)0x20000000u)       /*!< FIFO enable */
# define kFlexCAN_HALT_32      ((vuint32)0x10000000u)       /*!< Halt FlexCAN: request entering the freeze mode */
# define kFlexCAN_NOT_RDY_32   ((vuint32)0x08000000u)       /*!< Not Ready: FlexCAN is in DISABLE, DOZE or STOP mode */
# define kFlexCAN_WAK_MSK_32   ((vuint32)0x04000000u)       /*!< Wakeup Interrupt Mask: enable wakeup interrupt generation */
# define kFlexCAN_SOFT_RST_32  ((vuint32)0x02000000u)       /*!< Soft Reset: reset FlexCAN internal state and some memory mapped registers */
# define kFlexCAN_FRZ_ACK_32   ((vuint32)0x01000000u)       /*!< Freeze Mode Acknowledge */
# define kFlexCAN_SUPV_32      ((vuint32)0x00800000u)       /*!< Supervisor Mode */
# define kFlexCAN_SLF_WAK_32   ((vuint32)0x00400000u)       /*!< FlexCAN Self Wakeup by CAN bus activity */
# define kFlexCAN_WRN_EN_32    ((vuint32)0x00200000u)       /*!< Warning Interrupt Enable */
# define kFlexCAN_LPM_ACK_32   ((vuint32)0x00100000u)       /*!< Low Power Mode Acknowledge */
# define kFlexCAN_WAK_SRC_32   ((vuint32)0x00080000u)       /*!< Wakeup Source: enable filtered Rx input signal */
# define kFlexCAN_DOZE_32      ((vuint32)0x00040000u)       /*!< Doze Mode Enable: allow MCU to switch FlexCAN into DOZE low power mode */
# define kFlexCAN_NOT_DOZE_32  ((vuint32)0xFFFB0000u)       /*!< Doze Mode Disable: do not allow MCU to switch FlexCAN into DOZE low power mode */
# define kFlexCAN_SRX_DIS_32   ((vuint32)0x00020000u)       /*!< Self Reception Disable */
# define kFlexCAN_IRMQ_32      ((vuint32)0x00010000u)       /*!< Backwards Compatibility Configuration: enable Individual Rx Masks and queue feature */

# define kFlexCAN_LPPRIO_EN_32 ((vuint32)0x00002000u)       /*!< Local Priority Enable */
# define kFlexCAN_AEN_32       ((vuint32)0x00001000u)       /*!< Abort Enable: enables transmit abort feature */
# define kFlexCAN_FDEN_32      ((vuint32)0x00000800u)       /*!< CAN FD operation enable */
# define kFlexCAN_IDAM_32      ((vuint32)0x00000300u)       /*!< ID Acceptance Mode */
# define kFlexCAN_MAXMB_32     ((vuint32)0x0000007Fu)       /*!< Maximum Number of Message Buffers: maximum number of used message buffers = MAXMB+1 */
#endif
...
#define kFlexCAN_ERR_MSK   ((vuint32)0x00004000u)   /*!< FlexCAN Error interrupt mask */
...
#define kFlexCAN_RXTX_WARN     ((vuint32)0x00000300u)   /*!< RX/TX warning level reached */
#define kFlexCAN_STFERR        ((vuint32)0x00000400u)   /*!< Stuffing error */
#define kFlexCAN_FRMERR        ((vuint32)0x00000800u)   /*|< Form error */
#define kFlexCAN_CRCERR        ((vuint32)0x00001000u)   /*!< CRC error */
#define kFlexCAN_ACKERR        ((vuint32)0x00002000u)   /*!< ACK error */
#define kFlexCAN_BIT0ERR       ((vuint32)0x00004000u)   /*!< dominant bit sent as recessive received */
#define kFlexCAN_BIT1ERR       ((vuint32)0x00008000u)   /*!< recessive bit sent as dominant received */
#define kFlexCAN_OVRERR        ((vuint32)0x00200000u)   /*!< Error overrun */
#define kFlexCAN_STATUS_INT    (kFlexCAN_OVRERR | kFlexCAN_BOFF_INT | kFlexCAN_ERR_INT | kFlexCAN_WAKE_INT)
#define kFlexCAN_ERR_INT_CLEAR (kFlexCAN_OVRERR | kFlexCAN_ERR_INT)
...
#if defined (C_ENABLE_REGISTER_32BIT_ACCESS) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define kFlexCAN_MCR_REQ_ONLY_BITS_32 (kFlexCAN_MDIS_32 | kFlexCAN_FRZ_32 | kFlexCAN_HALT_32)
# define kFlexCAN_MCR_32               (kFlexCAN_MDIS_32 | kFlexCAN_FRZ_32 | kFlexCAN_HALT_32 | kFlexCAN_NOT_RDY_32 | kFlexCAN_FRZ_ACK_32 | kFlexCAN_LPM_ACK_32)
# define kFlexCAN_FREEZE_MODE_32       (kFlexCAN_FRZ_32 | kFlexCAN_HALT_32 | kFlexCAN_NOT_RDY_32 | kFlexCAN_FRZ_ACK_32) /* FlexCAN in FREEZE mode: FRZ, HALT, NOT_RDY and FRZ_ACK bit are set */
# define kFlexCAN_FREEZE_MODE_REQ_32   (kFlexCAN_FRZ_32 | kFlexCAN_HALT_32)
# define kFlexCAN_STOP_MODE_32         (kFlexCAN_NOT_RDY_32 | kFlexCAN_LPM_ACK_32) /* FlexCAN in STOP powerdown mode: NOT_RDY and LPM_ACK bits set */
# define kFlexCAN_DISABLE_MODE_32      (kFlexCAN_MDIS_32 | kFlexCAN_NOT_RDY_32 | kFlexCAN_LPM_ACK_32) /* FlexCAN in DISABLE powerdown mode: MDIS, NOT_RDY and LPM_ACK bit are set */
# define kFlexCAN_NORMAL_MODE_32       ((vuint32)0x00000000u) /* relevant bits for mode states must all be negated for NORMAL mode */
# define kFlexCAN_NORMAL_MODE_REQ_32   ((vuint32)0x00000000u)
/* FlexCAN is DISABLED, independent from FREEZE mode:
  -> MDIS and LPM_ACK bit are necessary to identify DISABLE mode
  -> NOT_RDY must not be checked because it also influenced by FREEZE mode
*/
# define kFlexCAN_DISABLE_ONLY_BITS_32 (kFlexCAN_MDIS_32 | kFlexCAN_LPM_ACK_32)
# define kNotFlexCAN_MCR_CFG_BTIS_32   (kFlexCAN_MCR_32 | kFlexCAN_SOFT_RST_32 | kFlexCAN_SUPV_32) /* user configurable bits are '0', not changeable bits are '1' */
# define kFlexCAN_MCR_MASK_32          ((vuint32)0xFFFF0000u)
#endif
...
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
/* Macros to access the CODE-bits in the control/status word ------------------*/
# define kCodeMask_32         ((vuint32)0x0F000000u)     /*!< Mask to access the CODE in the control/status word */
# define kNotDlcMask_32       ((vuint32)0xFF000000u)
# define kNotCodeMask_32      ((vuint32)0xF0FF0000u)

/* Code definitions for receive objects */
# define kRxCodeEmpty_32      ((vuint32)0x04000000u)    /*!< Message buffer is active and empty */
# define kRxCodeClear_32      ((vuint32)0x00F00000u)    /*!< Mask to clear control register but leave the ID type */
# define kRxCodeOverrun_32    ((vuint32)0x06000000u)    /*!< Second frame was received into a full buffer */
# define kRxCodeBusy_32       ((vuint32)0x01000000u)    /*!< Receive buffer locked */

/* Code definitions for transmit objects */
# define kTxCodeTransmit_32     ((vuint32)0x0C400000u)     /*!< transmit request in nominal bit rate  */
# define kTxCodeTransmitFD_32   ((vuint32)0xCC400000u)     /*!< transmit request for CAN-FD: EDL (extended data length) and BRS (bit rate switch) bit must be set */
# define kNotIDEMask_32         ((vuint32)0xFF0F0000u)
# define kTxDlcMask_32          ((vuint32)0x006F0000u)     /*!< Mask to access the DLC in the control/status word */
# define kTxCodeFree_32         ((vuint32)0x08000000u)     /*!< Transmit object free */
# define kTxCodeAbort_32        ((vuint32)0x09000000u)     /*!< Abort message transmission */

# if defined( C_ENABLE_EXTENDED_ID )
#  define kTxCodeInactive_32  ((vuint32)0x08200000u)       /*!< Transmit object inactive for extended or mixed IDs */
# else
#  define kTxCodeInactive_32  ((vuint32)0x08000000u)       /*!< Transmit object inactive for standard IDs */
# endif
#endif
...
#define kFlexCAN_WRMFRZ         (vuint32)0x10000000u  /*!< Enable unrestrictedwrite access to Flexcan memory */
...
#if defined (C_ENABLE_REGISTER_SUPPORT_E3) /* COV_CAN_REGISTER_SUPPORT_E3 */
/* Code definitions for E3 soft reset register*/
# define kFlexCAN_E3_SOFTRESET   ((vuint32)0x00000001u)   /*!< E3 soft reset register mask */

/* Code for E3 safty error interrupt status enable register */
# define kFlexCAN_E3_APB_PSLVERR_INT_STAT_EN   ((vuint32)0x00200000u)   /*!< E3 APB_PSLVERR_INT_STAT_EN */
#endif
...
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
/* all bits of CAN[MCR] except mode and reserved bits */
# if defined ( C_ENABLE_MB96TO127 ) || defined ( C_ENABLE_MB64TO95 ) /* COV_CAN_FLEXCAN3_DERIVATIVE_NUMBER_OF_HW_MB */
#  define maxmbMask_32                0x0000007Fu
# else
#  define maxmbMask_32                0x0000003Fu
# endif
# if defined( C_ENABLE_CAN_FD_USED )
#  define kCanRamCheckMaskMCR_32         (0x24EB3300u | kFlexCAN_FDEN_32 | maxmbMask_32)
# else
#  define kCanRamCheckMaskMCR_32         (0x24EB3300u | maxmbMask_32)
# endif

# define kCanRamCheckMailboxControl_32  0x0F7F0000u
#else
...
# define CAN_WRITE_PROTECTED_REG_32BIT(reg, val)        ApplCanWriteProtectedRegister32(&(reg), (vuint32)0xFFFFFFFFu, (val))
...
# define CAN_WRITE_PROTECTED_REG_32BIT(reg, val)        (reg) = (val)
...
*/
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanLL_TxIsObjFree(hwCh, txObjHandle) ((GLOBAL_MAILBOX_ACCESS((hwCh), (txObjHandle), control_ts) & kCodeMask_32) == kTxCodeFree_32)
#else
...
*/
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanLL_HwIsStop(hwCh) ((CAN_READ_PROTECTED_REG_32BIT((pFlexCAN(hwCh))->canmcr32) & kFlexCAN_MCR_32) == kFlexCAN_FREEZE_MODE_32)
#else
...
*/
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanLL_HwIsStopRequested(hwCh) ((CAN_READ_PROTECTED_REG_32BIT((pFlexCAN(hwCh))->canmcr32) & kFlexCAN_MCR_REQ_ONLY_BITS_32) == kFlexCAN_FREEZE_MODE_REQ_32)
#else
...
*/
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanLL_HwIsStart(hwCh) ((CAN_READ_PROTECTED_REG_32BIT((pFlexCAN(hwCh))->canmcr32) & kFlexCAN_MCR_32) == kFlexCAN_NORMAL_MODE_32)
#else
...
*/
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
# define CanLL_HwIsStartRequested(hwCh) ((CAN_READ_PROTECTED_REG_32BIT((pFlexCAN(hwCh))->canmcr32) & kFlexCAN_MCR_REQ_ONLY_BITS_32) == kFlexCAN_NORMAL_MODE_REQ_32)
#else
...
/* RAM CATEGORY 1 START */
V_DEF_VAR(CAN_STATIC volatile, vuint32, VAR_NOINIT) canLL_Estat[kCanNumberOfHwChannels];
/* RAM CATEGORY 1 END */

#if defined (CAN_ENABLE_SECURITY_EVENT_REPORTING) 
/* RAM CATEGORY 1 START */
V_DEF_VAR(CAN_STATIC volatile, vuint8, VAR_NOINIT) canLL_PassiveReportFlag[kCanNumberOfHwChannels];
/* RAM CATEGORY 1 END */
#endif
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_InitMailboxWriteReg16( CAN_CHANNEL_CANTYPE_FIRST CanChipMsgPtr16 regPtr, vuint16 value, vuint16 readMask, CanInitParaStructPtr initPara ) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
 ...
 */
/* CODE CATEGORY 4 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_WriteReg32( CAN_CHANNEL_CANTYPE_FIRST CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara ) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
  /* #10 write register value */
  *regPtr = value; /* SBSW_CAN_LL03 */
# if defined(C_ENABLE_CAN_RAM_CHECK_EXTENDED) 
...
# if defined( C_ENABLE_RX_FULLCAN_OBJECTS ) || defined( C_ENABLE_RX_BASICCAN_OBJECTS ) || defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
/****************************************************************************
 ...
 */
/* CODE CATEGORY 4 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_InitMailboxWriteReg32( CAN_CHANNEL_CANTYPE_FIRST CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara ) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
  vuint8 result = kCanFalse;
  /* #10 write register value */
  *regPtr = value; /* SBSW_CAN_LL03 */
 ...
 */
/* CODE CATEGORY 4 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_WriteProtectedReg32( CAN_CHANNEL_CANTYPE_FIRST vuint16 area, CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara ) /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
  /* #10 write register value */
  CAN_WRITE_PROTECTED_REG32(area, regPtr, value); /* SBSW_CAN_LL01 */
# if defined(C_ENABLE_CAN_RAM_CHECK_EXTENDED) 
  if (initPara->doRamCheck == kCanExecuteRamCheck)
  {
    vuint8 result = kCanFalse; /* PRQA S 2981,2982 */ /* MD_MSR_RetVal */
    volatile vuint32 readBack = CAN_READ_PROTECTED_REG32(area, regPtr); /* SBSW_CAN_LL01 */
    /* #20 read back value for RamCheck */
    if ((readBack & readMask) != (value & readMask)) /* COV_CAN_HARDWARE_FAILURE */
    {
      /* #30 return issue when read back value differs */
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_InitBegin( CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_FIRST CanInitParaStructPtr initPara ) /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
  ...
  returnValue1 = CanLL_SetFlexCANToInitMode(CAN_HW_CHANNEL_CANPARA_FIRST initPara->initObject);
  /* #20 Perform a soft reset */
  returnValue2 = CanLL_ExecuteSoftReset(CAN_HW_CHANNEL_CANPARA_ONLY);
#if defined (C_ENABLE_WORKAROUND_ERR008341)
  if (returnValue1 == kCanFailed) /* PRQA S 2991, 2995 */ /* MD_Can_ConstValue */ /* COV_CAN_LL_HARDWARE_BEHAVIOUR */
  {
    if (!Can_IsErr008341StopModeOfControllerData(canHwChannel))
    {
      /* #30 Start re-initialization once more if called from Can_Init */
      returnValue1 = CanLL_SetFlexCANToInitMode(CAN_HW_CHANNEL_CANPARA_FIRST initPara->initObject);
      returnValue2 = CanLL_ExecuteSoftReset(CAN_HW_CHANNEL_CANPARA_ONLY);
    }
  }
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  tmpCAMmcr32 = kCanRamCheckMaskMCR_32;
# else
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    tmpCAMmcr32 &= ((vuint32) ~kFlexCAN_FDEN_32);
# else
...
# endif
  ...
  {
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    /* #35 Write MCR 32 Bit register */
    CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, tmpCAMmcr32); /* SBSW_CAN_LL01 */
    CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, (ramCheckPattern32[loopRamCheckCounter] & tmpCAMmcr32)); /* SBSW_CAN_LL01 */

    /* #38 Check the 32 bit register content */
    if( (CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & tmpCAMmcr32) != (ramCheckPattern32[loopRamCheckCounter] & tmpCAMmcr32) ) /* COV_CAN_HARDWARE_FAILURE */ /* SBSW_CAN_LL01 */ /* PRQA S 3415 */ /* MD_Can_RuntimeOptimization_LL */
    {
      result = kCanTrue;
...
# else
    ...
    if(  ((CAN_READ_PROTECTED_REG(pFlexCANLocal->canmcr) & kCanRamCheckMaskMCR) != (ramCheckPattern16[loopRamCheckCounter] & kCanRamCheckMaskMCR))
      || ((CAN_READ_PROTECTED_REG(pFlexCANLocal->canmaxmb) & tmpCANmaxmb) != (ramCheckPattern16[loopRamCheckCounter] & tmpCANmaxmb))) /* COV_CAN_HARDWARE_FAILURE */ /* SBSW_CAN_LL01 */ /* SBSW_CAN_LL01 */ /* PRQA S 3415 */ /* MD_Can_RuntimeOptimization_LL */
    {
      result = kCanTrue;
      break; /* no need to carry on if check already failed */
    }
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  /* #55 Set all CAN register except the MCR register in unrestricted memory space (32 bit access) */
  CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_SUPV_32); /* SBSW_CAN_LL01 */

  /* #58 Set WRNEN flag in CAN_MCR register to check TWRNMSK and RWRNMASK in CTRL1 register (32 Bit access) */
  CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_WRN_EN_32); /* SBSW_CAN_LL01 */
# else
...
#endif
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  tmpCANmcr32 = CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_MCR_MASK_32; /* SBSW_CAN_LL01 */
  tmpCANmcr32 |= (vuint32)tmpCANmaxmb;
  /* #13 Write configured value to register */
  CanLL_WriteProtectedReg32(CAN_CHANNEL_CANPARA_FIRST CAN_AREA(canHwChannel), &pFlexCANLocal->canmcr32, tmpCANmcr32, kCanRamCheckMaskMCR_32, initPara); /* SBSW_CAN_LL01 */
  /* #14 Configure CAN[MCR].MCR register value */
  tmpCANmcr = (vuint16)((tmpCANmcr32 & kNotFlexCAN_MCR_CFG_BTIS_32) >> 16);
#else
...
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  tmpCANmcr32 = ((vuint32)(tmpCANmcr) << 16) | (vuint32)tmpCANmaxmb;
  CanLL_WriteProtectedReg32(CAN_CHANNEL_CANPARA_FIRST CAN_AREA(canHwChannel), &pFlexCANLocal->canmcr32, tmpCANmcr32, kCanRamCheckMaskMCR_32, initPara); /* SBSW_CAN_LL01 */
#else
...
#  if defined (CAN_ENABLE_SECURITY_EVENT_REPORTING) 
    /* #34 Enable Error interrupt */
    tmpCANcontrol1 |= kFlexCAN_ERR_MSK;
#  endif
  }
# endif
...
#  endif
    {
      ...
      {
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
        retVal &= ~CanLL_InitMailboxWriteReg32( CAN_CHANNEL_AND_HW_CHANNEL_CANPARA_FIRST &LOCAL_MAILBOX_ACCESS(canHwChannel, (vuint32)(initPara->hwObjHandle) + (vuint32)mailboxElement, control_ts), kTxCodeInactive_32, kCanRamCheckMailboxControl_32, initPara ); /* SBSW_CAN_LL02 */ /* PRQA S 2985 */ /* MD_Can_ConstValue */
#  else
...
# endif
    {
      retVal = kCanOk;
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
      retVal &= ~CanLL_InitMailboxWriteReg32( CAN_CHANNEL_AND_HW_CHANNEL_CANPARA_FIRST &LOCAL_MAILBOX_ACCESS(canHwChannel, (vuint32)(initPara->hwObjHandle), control_ts), kTxCodeInactive_32, kCanRamCheckMailboxControl_32, initPara ); /* SBSW_CAN_LL02 */ /* PRQA S 2985 */ /* MD_Can_ConstValue */
# else
...
#  if defined(C_ENABLE_MULTIPLEXED_TRANSMISSION)
  if ( (initPara->mailboxHandle >= CAN_HL_MB_TX_BASIC_STARTINDEX(canHwChannel)) && (initPara->mailboxHandle < CAN_HL_MB_TX_BASIC_STOPINDEX(canHwChannel)) ) /* COV_CAN_MAILBOX_ORDER */
  {
    ...
    {
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
      LOCAL_MAILBOX_ACCESS(canHwChannel, (vuint16)initPara->hwObjHandle + (vuint16)mailboxElement, control_ts) = 0u; /* set all mailboxes inactive */ /* SBSW_CAN_LL02 */
#   else
...
#  endif
  {
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    LOCAL_MAILBOX_ACCESS(canHwChannel, initPara->hwObjHandle, control_ts) = 0u; /* SBSW_CAN_LL02 */
#  else
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    retVal &= ~CanLL_InitMailboxWriteReg32( CAN_CHANNEL_AND_HW_CHANNEL_CANPARA_FIRST &LOCAL_MAILBOX_ACCESS(canHwChannel, (vuint32)(initPara->hwObjHandle), control_ts), kRxCodeEmpty_32 | ((vuint32)(initPara->idType) << 16), kCanRamCheckMailboxControl_32, initPara ); /* SBSW_CAN_LL02 */ /* PRQA S 2985 */ /* MD_Can_ConstValue */
#else
...
#  if defined( C_ENABLE_MIXED_ID )
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    if((LOCAL_MAILBOX_ACCESS(canHwChannel, initPara->hwObjHandle, control_ts) & ((vuint32)kCanIdTypeExt << 16)) == 0u) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* SBSW_CAN_LL02 */
#   else
...
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  GLOBAL_MAILBOX_ACCESS(canHwChannel, initPara->hwObjHandle, control_ts) = 0u; /* deactivate receive mailbox */ /* SBSW_CAN_LL02 */
#  else
...
#   if defined(C_ENABLE_MIXED_ID)   
      ...
      {
#     if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
        retVal &= ~CanLL_InitMailboxWriteReg32( CAN_CHANNEL_AND_HW_CHANNEL_CANPARA_FIRST &LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts), kRxCodeEmpty_32, kCanRamCheckMailboxControl_32, initPara ); /* SBSW_CAN_LL02 */ /* PRQA S 2985 */ /* MD_Can_ConstValue */
#     else
...
#   endif
      {
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
        retVal &= ~CanLL_InitMailboxWriteReg32( CAN_CHANNEL_AND_HW_CHANNEL_CANPARA_FIRST &LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts), kRxCodeEmpty_32 | ((vuint32)kCanIdTypeExt << 16), kCanRamCheckMailboxControl_32, initPara ); /* SBSW_CAN_LL02 */ /* PRQA S 2985 */ /* MD_Can_ConstValue */
#   else
...
#  endif
    {
      ...
      for(filterHandle = 0u; filterHandle < NUMBER_OF_FILTERS(canHwChannel); filterHandle++)
      {
        ...
        if(((vuint32)(Can_GetInitCodeOfInitBasicCan(Can_GetInitBasicCanIndex(initPara->initObject) + filterHandle)) & kExtIDBit) != 0u) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */ /* PRQA S 2991,2992,2995,2996 */ /* MD_Can_ConstValue */ /* COV_CAN_GENDATA_FAILURE */
        {
...
#  if defined ( C_ENABLE_CLASSIC_MAILBOX_LAYOUT )
  ...
  for (hwObjCount = 0u; hwObjCount < Can_GetMailboxSize(initPara->mailboxHandle); hwObjCount++)
  {
    ...
    hwObjHandle = initPara->hwObjHandle + hwObjCount;
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    GLOBAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = 0u; /* SBSW_CAN_LL02 */
#   else
...
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_FEN_32); /* SBSW_CAN_LL01 */
#else
...
#    endif
    {
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
      LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = 0u; /* deactivate receive mailbox */ /* SBSW_CAN_LL02 */
#   else
...
#if defined (C_ENABLE_REGISTER_SUPPORT_E3) /* COV_CAN_REGISTER_SUPPORT_E3 */
  /* #50 Initialize additional E3 SAFTY_ERR_IRQ_STATUS_EN register */
  pCanE3Register(canHwChannel)->safetyErrIrqStatusEn &= (vuint32)(~kFlexCAN_E3_APB_PSLVERR_INT_STAT_EN); /* SBSW_CAN_LL09 */
  /* #60 Clear additional E3 SAFTY_ERR_IRQ_STATUS register */
  pCanE3Register(canHwChannel)->regParityErrIntStat |= kFlexCAN_E3_APB_PSLVERR_INT_STAT_EN; /* SBSW_CAN_LL09 */
#endif
  CAN_DUMMY_STATEMENT(initPara); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
...
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
      LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = (vuint32)0x00550000u; /* SBSW_CAN_LL02 */
      if((LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) & (vuint32)0x007F0000u) != (vuint32)0x00550000u) /* COV_CAN_HARDWARE_FAILURE */ /* SBSW_CAN_LL02 */
      {
        result = kCanTrue;
      }
      LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = (vuint32)0x002A0000u; /* SBSW_CAN_LL02 */
      if((LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) & (vuint32)0x007F0000u) != (vuint32)0x002A0000u) /* COV_CAN_HARDWARE_FAILURE */ /* SBSW_CAN_LL02 */
      {
        result = kCanTrue;
      }
      LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = (vuint32)0x00000000u; /* SBSW_CAN_LL02 */
      if((LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) & (vuint32)0x007F0000u) != (vuint32)0x00000000u) /* COV_CAN_HARDWARE_FAILURE */ /* SBSW_CAN_LL02 */
      {
        result = kCanTrue; /* PRQA S 2981,2982 */ /* MD_MSR_RetVal */
      }
#  else
        ...
        for(filterHandle = 0u; filterHandle < NUMBER_OF_FILTERS(canHwChannel); filterHandle++)
        {
          if (filterHandle < NUMBER_OF_FULL_CONFIGURABLE_FILTERS(canHwChannel)) /* PRQA S 2991, 2995 */ /* MD_Can_ConstValue */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
          {
            for(i = 0u; i < 3u; i++)
            {
              ...
              {
                result = kCanTrue; /* PRQA S 2981, 2982, 2983 */ /* MD_MSR_RetVal, MD_MSR_RetVal, MD_MSR_DummyStmt */
              }
            }
          }
        }
...
# endif
  ...
  canLL_PassiveReportFlag[channel] = kCanTrue; /* SBSW_CAN_LL14 */
#endif

#if defined (C_ENABLE_WORKAROUND_ERR008341)
  Can_SetErr008341StopModeOfControllerData(channel, FALSE); /* SBSW_CAN_LL14 */
#endif
...
#  endif
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  GLOBAL_MAILBOX_ACCESS(canHwChannel, txCancellationPara->hwObjHandle, control_ts) = kTxCodeAbort_32; /* SBSW_CAN_LL02 */
#  else
...
# endif
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = (vuint32)tmpControlVal << 16; /* SBSW_CAN_LL02 */
# else
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) |= kTxCodeTransmit_32; /* start tx of the message */ /* SBSW_CAN_LL02 */
# else
...
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    LOCAL_MAILBOX_ACCESS(canHwChannel, INDEX_RSVD_MB(canHwChannel), control_ts) |= kTxCodeInactive_32; /* SBSW_CAN_LL02 */
    LOCAL_MAILBOX_ACCESS(canHwChannel, INDEX_RSVD_MB(canHwChannel), control_ts) |= kTxCodeInactive_32; /* SBSW_CAN_LL02 */
#  else
...
# if defined (CAN_ENABLE_SECURITY_EVENT_REPORTING) 
  CanLL_ErrorStateActiveTransitionOccured(CAN_HW_CHANNEL_CANPARA_ONLY);
# endif
...
{
  vuint32 iFlags;
  tFlexCANPtr pFlexCANLocal = pFlexCAN(canHwChannel); /* PRQA S 3679 */ /* MD_Can_NoneConstParameterPointer */
...
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    GLOBAL_MAILBOX_ACCESS(canHwChannel, txConfPara->hwObjHandle, control_ts) = kTxCodeFree_32; /* SBSW_CAN_LL02 */
#else
...
#   endif
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    txConfPara->txStructConf->pChipMsgObj = (CanChipMsgPtr)&(GLOBAL_MAILBOX_ACCESS(canHwChannel, txConfPara->hwObjHandle, control_ts)); /* SBSW_CAN_LL04 */
#   else
...
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts = LOCAL_MAILBOX_ACCESS(canHwChannel, rxBasicPara->hwObjHandle, control_ts); /* SBSW_CAN_LL06 */
  if ((Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts & kRxCodeBusy_32) == kRxCodeBusy_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */
  {
    ...
    } while(((Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts & kRxCodeBusy_32) == kRxCodeBusy_32) && (loopResult == CAN_OK)); /* COV_CAN_TIMEOUT_DURATION */ /* PRQA S 2995, 2843 */ /* MD_Can_ConstValue, MD_Can_HL_DereferencePointerValue */
    CanLL_ApplCanTimerEnd(kCanLoopMsgReception); /* stop hw loop timer */ /* SBSW_CAN_LL08 */ /* PRQA S 2843 */ /* MD_Can_HL_DereferencePointerValue */
  }
#  else
  ...
  if ((Can_GetRxMsgBufferOfControllerData(canHwChannel).control & kRxCodeBusy) == kRxCodeBusy) /* COV_CAN_HARDWARE_PROCESSING_TIME */
  {
    ...
    { /* Check busy state of receive object */
      Can_GetRxMsgBufferOfControllerData(canHwChannel).control = LOCAL_MAILBOX_ACCESS(canHwChannel, rxBasicPara->hwObjHandle, control); /* SBSW_CAN_LL06 */
      loopResult = CanLL_ApplCanTimerLoop(kCanLoopMsgReception);
    } while(((Can_GetRxMsgBufferOfControllerData(canHwChannel).control & kRxCodeBusy) == kRxCodeBusy) && (loopResult == CAN_OK)); /* COV_CAN_TIMEOUT_DURATION */ /* PRQA S 2995, 2843 */ /* MD_Can_ConstValue, MD_Can_HL_DereferencePointerValue */
    CanLL_ApplCanTimerEnd(kCanLoopMsgReception); /* stop hw loop timer */ /* SBSW_CAN_LL08 */ /* PRQA S 2843 */ /* MD_Can_HL_DereferencePointerValue */
  }
#  endif
# else /* C_ENABLE_CLASSIC_MAILBOX_LAYOUT */
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  Can_GetRxMsgBufferOfControllerData(canHwChannel).timestamp_32 = pFlexCANLocal->timer; /* unlock current receive buffer */ /* SBSW_CAN_LL01 */
# else
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  rxBasicPara->rxStruct.pChipMsgObj = (CanChipMsgPtr) &(Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts); /* SBSW_CAN_LL04 */
# else
...
#  if defined ( C_ENABLE_CLASSIC_MAILBOX_LAYOUT )
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  if((Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts & kCodeMask_32) == kRxCodeOverrun_32)
#   else
...
#  endif /* C_ENABLE_CLASSIC_MAILBOX_LAYOUT */
  ...
  /* #70 Check for error active transition */
# if defined (CAN_ENABLE_SECURITY_EVENT_REPORTING) 
  CanLL_ErrorStateActiveTransitionOccured(CAN_HW_CHANNEL_CANPARA_ONLY);
# endif
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts = LOCAL_MAILBOX_ACCESS(canHwChannel, rxFullPara->hwObjHandle, control_ts); /* SBSW_CAN_LL06 */
  if ((Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts & kRxCodeBusy_32) == kRxCodeBusy_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */
  {
    CanLL_ApplCanTimerStart(kCanLoopMsgReception); /* start hw loop timer */ /* SBSW_CAN_LL08 */
    do
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  rxFullPara->rxStruct.pChipMsgObj = (CanChipMsgPtr) &(Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts); /* SBSW_CAN_LL04 */
# else
...
# if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  if ((Can_GetRxMsgBufferOfControllerData(canHwChannel).control_ts & kCodeMask_32) == kRxCodeOverrun_32) /* COV_CAN_FULL_OVERRUN_HANDLING */
# else
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_ErrorStatePassiveTransitionOccured( CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  if ((canLL_PassiveReportFlag[canHwChannel] == kCanTrue) && ((canLL_Estat[canHwChannel] & kFlexCAN_FCS) == kFlexCAN_FCS_EP))
  {
    canLL_PassiveReportFlag[canHwChannel] = kCanFalse; /* SBSW_CAN_LL14 */
    retVal = kCanTrue;
  }
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_ErrorNotificationHandling( CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  if((canLL_Estat[canHwChannel] & kFlexCAN_BIT0ERR) == kFlexCAN_BIT0ERR)
  {
  ...
  if((canLL_Estat[canHwChannel] & kFlexCAN_BIT1ERR) == kFlexCAN_BIT1ERR)
  {
  ...
  if((canLL_Estat[canHwChannel] & kFlexCAN_ACKERR) == kFlexCAN_ACKERR)
  {
  ...
  if((canLL_Estat[canHwChannel] & kFlexCAN_FRMERR) == kFlexCAN_FRMERR)
  {
  ...
  if((canLL_Estat[canHwChannel] & kFlexCAN_STFERR) == kFlexCAN_STFERR)
  {
  ...
  if((canLL_Estat[canHwChannel] & kFlexCAN_CRCERR) == kFlexCAN_CRCERR)
  {
    /* #60 CRC failed */
  ...
  pFlexCANLocal->estat = kFlexCAN_ERR_INT_CLEAR; /* SBSW_CAN_LL01 */
}
/* CODE CATEGORY 2 END */

/**********************************************************************************************************************
 *  CanLL_ErrorStateActiveTransitionOccured
 *********************************************************************************************************************/
/*
|<DataModelStart>| CanLL_ErrorStateActiveTransitionOccured
Relation_Context:
# from CanHL_ErrorHandling() #
# from CanLL_TxEnd #
# from CanLL_TxIsGlobalConfPending #
# from CanLL_RxBasicIsGlobalIndPending #
# from CanLL_RxFullIsGlobalIndPending #
...
*/
/* CODE CATEGORY 2 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_ErrorStateActiveTransitionOccured(CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY)
{
  /* #10 Check if a transition to error state active has occurred */
# if defined( C_SINGLE_RECEIVE_CHANNEL )
  if ((CanRxActualErrorCounter() < 128u) && (CanTxActualErrorCounter() < 128u)) /* COV_CAN_ACTIVE_TRANSITION_STIMULATION */
# else
  if ((CanRxActualErrorCounter(canHwChannel) < 128u) && (CanTxActualErrorCounter(canHwChannel) < 128u)) /* COV_CAN_ACTIVE_TRANSITION_STIMULATION */
# endif
  {
    canLL_PassiveReportFlag[canHwChannel] = kCanTrue; /* SBSW_CAN_LL14 */
  }
}
/* CODE CATEGORY 2 END */
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_ErrorHandlingBegin(CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  canLL_Estat[canHwChannel] = pFlexCANLocal->estat; /* SBSW_CAN_LL14 */
}
/* CODE CATEGORY 2 END */
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_BusOffOccured(CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY)
{
  tFlexCANPtr pFlexCANLocal = pFlexCAN(canHwChannel);
  vuint8 retVal = kCanFalse; /* PRQA S 2981,2982 */ /* MD_MSR_RetVal */
  CANSFR_TYPE busOffErrFlags;
  
  /* #10 Check for BusOff */
  if((canLL_Estat[canHwChannel] & kFlexCAN_BOFF_INT) != 0u) /* COV_CAN_BUSOFF_HANDLING */
  {
    /* #20 clear busoff and error interrupt flags */
#if defined (CAN_ENABLE_SECURITY_EVENT_REPORTING) 
    busOffErrFlags = (CANSFR_TYPE)(kFlexCAN_BOFF_INT);
#else
    busOffErrFlags = (CANSFR_TYPE)(kFlexCAN_BOFF_INT | kFlexCAN_ERR_INT);
#endif
    pFlexCANLocal->estat = busOffErrFlags; /* clear busoff and error interrupt flags */ /* SBSW_CAN_LL01 */
    ...
    /* #30 Delete pending transmit requests */
    {
      ...
      {
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
        LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) = kTxCodeInactive_32; /* set all mailboxes inactive */ /* SBSW_CAN_LL02 */
#  else
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_ErrorHandlingEnd(CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  canLL_Estat[canHwChannel] = 0x0uL; /* SBSW_CAN_LL14 */
  CAN_CHANNEL_AND_HW_CHANNEL_DUMMY_STATEMENT; /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
}
/* CODE CATEGORY 2 END */
...
#   if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
    LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) &= kRxCodeClear_32; /* clear control register and do not change the ID type */ /* SBSW_CAN_LL02 */
    LOCAL_MAILBOX_ACCESS(canHwChannel, hwObjHandle, control_ts) |= kRxCodeEmpty_32; /* set mailbox ready for receive */ /* SBSW_CAN_LL02 */
#   else
...
*/
/* CODE CATEGORY 1 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_CanInterruptDisable(CAN_HW_CHANNEL_CANTYPE_FIRST tCanLLCanIntOldPtr localInterruptOldFlagPtr) /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */
{
#if defined( C_ENABLE_CAN_RXTX_INTERRUPT )   || \
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_SetFlexCANToInitMode(CAN_HW_CHANNEL_CANTYPE_FIRST CanInitHandle initObject)
{
  ...
  /* ----- Implementation ----------------------------------------------- */
#if defined (C_ENABLE_REGISTER_SUPPORT_E3) /* COV_CAN_REGISTER_SUPPORT_E3 */
  /* #10 Initialize additional E3 SOFT_RESET register */
  CAN_WRITE_PROTECTED_REG_RESET_32BIT(pCanE3Register(canHwChannel)->softReset, kFlexCAN_E3_SOFTRESET); /* SBSW_CAN_LL09 */
#endif
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
  /* #20 Check if FlexCAN is DISABLED or in a NON_BUSOFF state (and in NON_LOM mode) */
  if (((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_DISABLE_MODE_32) == kFlexCAN_DISABLE_MODE_32)
      || (((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->estat) & kFlexCAN_FCS_BOFF) == 0u) /* PRQA S 3415 */ /* MD_Can_RuntimeOptimization_LL */
# if defined(C_ENABLE_SILENT_MODE)
      && ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->control1) & kFlexCAN_LOM) == 0u) /* PRQA S 3415 */ /* MD_Can_RuntimeOptimization_LL */
# endif
# if defined (C_ENABLE_WORKAROUND_ERR008341)
      && (!Can_IsErr008341StopModeOfControllerData(canHwChannel))
# endif
    )) /* COV_CAN_INIT_STIMULATION */ /* SBSW_CAN_LL01 */ /* SBSW_CAN_LL01 */ /* SBSW_CAN_LL01 */
    {
      /* #30 Check if FlexCAN is ENABLED */
      if ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_DISABLE_ONLY_BITS_32) == 0u) /* COV_CAN_INIT_STIMULATION */ /* SBSW_CAN_LL01 */
      {
        /* #40 Enter FREEZE mode (INIT mode) of FlexCAN */
        CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_FRZ_32); /* SBSW_CAN_LL01 */
        CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_HALT_32); /* SBSW_CAN_LL01 */
        if ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_MCR_32) != kFlexCAN_FREEZE_MODE_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */ /* SBSW_CAN_LL01 */
        {
          ...
          } while(((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_MCR_32) != kFlexCAN_FREEZE_MODE_32) && (loopResult == CAN_OK)); /* COV_CAN_TIMEOUT_DURATION */ /* SBSW_CAN_LL01 */ /* PRQA S 2995,0303 */ /* MD_Can_ConstValue */ /* MD_Can_HwAccess */
 ...
 # endif
        ...
        /* #50 Enter DISABLE mode of FlexCAN for clock selection */
        CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_MDIS_32); /* disable FlexCAN module before clock selection */ /* SBSW_CAN_LL01 */
        if ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_LPM_ACK_32) != kFlexCAN_LPM_ACK_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */ /* SBSW_CAN_LL01 */
        {
          ...
          } while(((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_LPM_ACK_32) != kFlexCAN_LPM_ACK_32) && (loopResult == CAN_OK)); /* COV_CAN_TIMEOUT_DURATION */ /* SBSW_CAN_LL01 */ /* PRQA S 2995,0303 */ /* MD_Can_ConstValue */ /* MD_Can_HwAccess */
 ...
 # endif
      ...
      /* #70 Leave DISABLE mode of FlexCAN */
      CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_MDIS_32); /* clear MDIS bit */ /* SBSW_CAN_LL01 */
      if ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_LPM_ACK_32) == kFlexCAN_LPM_ACK_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */ /* SBSW_CAN_LL01 */
      {
...
#else
  /* #80 Check if FlexCAN is DISABLED or in a NON_BUSOFF state (and in NON_LOM mode) */
...
# endif
      ...
      /* #110 Enter DISABLE mode of FlexCAN for clock selection */
...
# endif
    ...
    /* #130 Leave DISABLE mode of FlexCAN */
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_ExecuteSoftReset(CAN_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  CAN_WRITE_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_SOFT_RST_32); /* SBSW_CAN_LL01 */
  if ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_SOFT_RST_32) == kFlexCAN_SOFT_RST_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */ /* SBSW_CAN_LL01 */
  {
    ...
    } while(((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_SOFT_RST_32) == kFlexCAN_SOFT_RST_32) && (loopResult1 == CAN_OK)); /* SBSW_CAN_LL01 */ /* COV_CAN_TIMEOUT_DURATION */ /* PRQA S 2995,0303 */ /* MD_Can_ConstValue */ /* MD_Can_HwAccess */
...
# if defined( C_ENABLE_CAN_FD_USED ) && defined( C_ENABLE_WORKAROUND_ERR010368 )
  ...
  if (Can_IsHasCANFDBaudrateOfControllerConfig(canHwChannel)) /* COV_CAN_FD_BAUDRATE_AVAILABILITY */
  {
    ...
    if ((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_SOFT_RST_32) == kFlexCAN_SOFT_RST_32) /* COV_CAN_HARDWARE_PROCESSING_TIME */ /* SBSW_CAN_LL01 */
    {
      ...
      } while(((CAN_READ_PROTECTED_REG_32BIT(pFlexCANLocal->canmcr32) & kFlexCAN_SOFT_RST_32) == kFlexCAN_SOFT_RST_32) && (loopResult2 == CAN_OK)); /* SBSW_CAN_LL01 */ /* COV_CAN_TIMEOUT_DURATION */ /* PRQA S 2995,0303 */ /* MD_Can_ConstValue */ /* MD_Can_HwAccess */
      CanLL_ApplCanTimerEnd(kCanLoopResetInit);  /* stop hw loop timer */ /* SBSW_CAN_LL08 */
    }
  }
# endif
#else
  /* #50 Execute SoftReset of FlexCAN */
  ...
  {
    /* #60 Wait for soft reset confirmation from hardware */
    CanLL_ApplCanTimerStart(kCanLoopResetInit); /* start hw loop timer */ /* SBSW_CAN_LL08 */
    do
    { /* wait for SOFT_RST */
      loopResult1 = CanLL_ApplCanTimerLoop(kCanLoopResetInit);
...
# if defined( C_ENABLE_CAN_FD_USED ) && defined( C_ENABLE_WORKAROUND_ERR010368 )
  /* #70 Execute SoftReset of FlexCAN second time (errata e10368) if CAN FD is enabled */
  if (Can_IsHasCANFDBaudrateOfControllerConfig(canHwChannel)) /* COV_CAN_FD_BAUDRATE_AVAILABILITY */
  {
    CAN_WRITE_PROTECTED_REG(pFlexCANLocal->canmcr, kFlexCAN_SOFT_RST); /* SBSW_CAN_LL01 */
    if ((CAN_READ_PROTECTED_REG(pFlexCANLocal->canmcr) & kFlexCAN_SOFT_RST) == kFlexCAN_SOFT_RST) /* COV_CAN_HARDWARE_PROCESSING_TIME */ /* SBSW_CAN_LL01 */
    {
      /* #80 Wait for soft reset confirmation from hardware second time (errata e10368) if CAN FD is enabled */
      CanLL_ApplCanTimerStart(kCanLoopResetInit); /* start hw loop timer */ /* SBSW_CAN_LL08 */
      do
      { /* wait for SOFT_RST */
        loopResult2 = CanLL_ApplCanTimerLoop(kCanLoopResetInit);
...
# endif
  ...
  /* #90 Reset SUPV bit to grant access to CAN register (except MCR register) in User Mode */
...
# endif
# if defined (C_ENABLE_WORKAROUND_ERR008341)
      Can_SetErr008341StopModeOfControllerData(canHwChannel, TRUE); /* SBSW_CAN_LL14 */
# endif
      retVal = CanHL_ReInit(CAN_CHANNEL_CANPARA_FIRST ramCheck);
# if defined (C_ENABLE_WORKAROUND_ERR008341)
      Can_SetErr008341StopModeOfControllerData(canHwChannel, FALSE); /* SBSW_CAN_LL14 */
# endif
    }
  }
# if defined (C_ENABLE_SILENT_MODE)
...
# endif
  ...
  {
# if defined (C_ENABLE_WORKAROUND_ERR008341)
    /* #45 Stop Transition in case of errata ERR008341 */
    Can_SetErr008341StopModeOfControllerData(canHwChannel, TRUE); /* SBSW_CAN_LL14 */
    retVal = CanHL_ReInit(CAN_CHANNEL_CANPARA_FIRST ramCheck);
    Can_SetErr008341StopModeOfControllerData(canHwChannel, FALSE); /* SBSW_CAN_LL14 */
# else
    ...
    { /* #60 Check for stop transition finished */
      ...
      CanHL_CleanUpSendState(CAN_CHANNEL_CANPARA_ONLY); /* PRQA S 2987 */ /* MD_Can_EmptyFunction */
#  if defined (CAN_ENABLE_SECURITY_EVENT_REPORTING) 
      canLL_PassiveReportFlag[canHwChannel] = kCanTrue; /* SBSW_CAN_LL14 */
#  endif
      retVal = kCanOk;
...
#  if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
      CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_MDIS_32); /* clear MDIS bit */ /* SBSW_CAN_LL01 */
      CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_FRZ_32);  /* set FRZ bit */ /* SBSW_CAN_LL01 */
      CAN_WRITE_PROTECTED_REG_SET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_HALT_32); /* set HALT bit */ /* SBSW_CAN_LL01 */
#  else
      CAN_WRITE_PROTECTED_REG_RESET(pFlexCANLocal->canmcr, kFlexCAN_MDIS); /* clear MDIS bit */ /* SBSW_CAN_LL01 */
...
#if defined ( C_ENABLE_REGISTER_32BIT_ACCESS ) /* COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS */
        CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_MDIS_32); /* clear MDIS bit */ /* SBSW_CAN_LL01 */
        CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_HALT_32); /* clear HALT bit */ /* SBSW_CAN_LL01 */
        CAN_WRITE_PROTECTED_REG_RESET_32BIT(pFlexCANLocal->canmcr32, kFlexCAN_FRZ_32);  /* clear FRZ bit  */ /* SBSW_CAN_LL01 */
#else
        CAN_WRITE_PROTECTED_REG_RESET(pFlexCANLocal->canmcr, kFlexCAN_MDIS); /* clear MDIS bit */ /* SBSW_CAN_LL01 */
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_ComputeInterruptType(CAN_HW_CHANNEL_CANTYPE_FIRST CanObjectHandle index) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
{
  ...
  {
    CanObjectHandle mailboxHandle = Can_GetHwToMbHandle(canHwChannel, index); /* PRQA S 2981,2982,2843 */ /* MD_MSR_RetVal,MD_MSR_RetVal,MD_Can_HL_DereferencePointerValue */
...
MD_Can_InlineExternalLinkage
PRQA message 3238, 3240, 3242
  Reason: Compiler that do not support static inline but only inline may have an external linkage problem.
  Risk: Side effects of function may always be expected.
  Prevention: Code inspection and test of different variants in the component test.
...
\ID SBSW_CAN_LL14
 \DESCRIPTION Write access to canLL_canStartReinitState, canLL_PassiveReportFlag, canLL_Estat, CanErr008341StopMode with channel as index.
 \COUNTERMEASURE \R [CM_CAN_LL03]
                 \R [CM_CAN_LL07]
...
\ID COV_CAN_ACTIVE_TRANSITION_STIMULATION
  \ACCEPT TF tx tf
  \REASON RX and TX error counters must be less than 128. One of them does never exceed 128 due error stimulation. Stimulation of RX counter was done manually to cover this statement completly. The behaviour was as expected.

\ID COV_CAN_REGISTER_SUPPORT_E3
  \ACCEPT TX
  \ACCEPT XF
  \REASON Depending on E3 derivative result is always true of false. Tested with E3 derivative and non E3 derivative.

\ID COV_CAN_FLEXCAN3_DERIVATIVE_32BIT_ACCESS
  \ACCEPT TX
  \ACCEPT XF
  \ACCEPT TX tf tf tx
  \ACCEPT TF tf tf xf
  \REASON Depends on derivatives that supports 32 bit register access only.
