 ...
 *
 **********************************************************************************************************************/
/* PRQA S 6050, 6030, 6080 1 */ /* MD_MSR_STCAL, MD_MSR_STCYC, MD_MSR_STMIF */
CANTP_LOCAL FUNC(void, CANTP_CODE) CanTp_CanIfRxIndication(PduIdType SduHdl,
                                                           uint8     FrameType,
                                                           P2CONST(PduInfoType, AUTOMATIC, CANTP_APPL_DATA) pPayloadInfo,
                                                           P2CONST(PduInfoType, AUTOMATIC, CANTP_APPL_DATA) pMetadataInfo)
...
# endif
  ...
  {
    CanTp_ApplRxIndication(CanTp_RxCfg_GetPduRRxSduId(lRxHdl), NotifyCode)
...
# endif
  {
    CanTp_ApplTxConfirmation(CanTp_TxCfg_GetPduRTxSduId(lTxHdl), NotifyCode)                                           /* SBSW_CANTP_APPLNOTIFICATION_CALL_PDUINFO */   
