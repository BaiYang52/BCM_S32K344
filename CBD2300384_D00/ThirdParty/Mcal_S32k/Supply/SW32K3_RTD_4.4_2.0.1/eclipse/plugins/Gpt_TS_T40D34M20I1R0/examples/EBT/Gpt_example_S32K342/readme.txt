...
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            - XS32K3X2CVB-Q172 PCB 48307 RevX1 SCH RevA
            - X-S32K3XXX-MB PCB 47386 RevA SCH RevA (Motherboard)
        2.2.2 Connections
            A wire connection is required between the following:
               - pin j352.4  (PTB13 - output).
               - RGBLED0_RED (PTA29 - gpio LED blink).
               note: It's possbile that this pin is not connected between motherboard and daughtercard. 
                     A possible workaround is to swicth to PTB25 pin.
        2.2.3 Debugger
    ...
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - PLUGINS_DIR The path to the Tresos plugins directory
                Ex: PLUGINS_DIR = C:/EB/tresos/27.1.0/plugins
            Procedure:
