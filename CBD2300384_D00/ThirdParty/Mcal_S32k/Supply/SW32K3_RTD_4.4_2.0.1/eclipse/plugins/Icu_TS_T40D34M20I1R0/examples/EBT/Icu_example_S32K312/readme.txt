    ...
    2.1 Hardware installation
        ...
        2.2.2 Connections
            A wire connection is required between the following:
                pin J4.2 (PTA11 - gpio trigger)    to  J2.4 (PTB13 - EMIOS_0_CH_1 input).
                pin J2.22   (PTA0 - gpio trigger)    to  J412.16 (PTA14 - SIUL2_CH_22 input).
                pin J2.19   (PTA1 - gpio trigger)    to  J412.19 (PTE2 - Wkpu_27 input).
        2.2.3 Debugger
