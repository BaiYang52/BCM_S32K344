...
#define SIUL2_ICU_IP_SW_MAJOR_VERSION_C            2
...
SIUL2_Type * const Siul2_Icu_Ip_pBase[] = IP_SIUL2_BASE_PTRS;
...
Siul2_Icu_Ip_State Siul2_Icu_Ip_aChannelState[SIUL2_INSTANCE_COUNT][SIUL2_ICU_IP_NUM_OF_CHANNELS];

#if (SIUL2_ICU_IP_DUAL_CLOCK_MODE_API == STD_ON)
static Siul2_Icu_Ip_InstanceConfigType Siul2_Icu_Ip_aInstanceConfiguration[SIUL2_INSTANCE_COUNT];
#endif
...
#if(SIUL2_ICU_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(instance < SIUL2_INSTANCE_COUNT);
#endif
