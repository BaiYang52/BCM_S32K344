...
/* Siul2 Icu channel used - 16 */
#define SIUL2_ICU_CHN_16        16U
...
void LpuartSlaveCallback (uint8 Instance, const  Lpuart_Lin_Ip_StateStructType *LpuartStateStruct)
{
    switch (LpuartStateStruct->CurrentEventId)
    {
        ...
        case LPUART_LIN_IP_BAUDRATE_ADJUSTED:
            ...
            /* Re-configure PTD3 as LPUART_RX */
            Siul2_Port_Ip_SetInputBuffer(PORTD_L_HALF, 3, FALSE, 157, PORT_INPUT_MUX_ALT0);
            Siul2_Port_Ip_SetInputBuffer(PORTD_L_HALF, 3, TRUE, 190, PORT_INPUT_MUX_ALT3);
...
int main(void)
{
    ...
    Pit_Ip_InitChannel(PIT_INST_0, &PIT_0_ChannelConfig_PB[0]);
    ...
    Siul2_Icu_Ip_EnableInterrupt(SIUL2_ICU_INST_0, SIUL2_ICU_CHN_16);
    Siul2_Icu_Ip_EnableNotification(SIUL2_ICU_INST_0, SIUL2_ICU_CHN_16);
    ...
    do
    {
        FlexioMasterStatus = Flexio_Lin_Ip_GetStatus(Flexio_Lin_Ip_Sa_pHwConfigPB_0_VS_0.Instance, (uint8 **)&DummyBuffer);
    }
    ...
    do
    {
        FlexioSlaveStatus = Flexio_Lin_Ip_GetStatus(Flexio_Lin_Ip_Sa_pHwConfigPB_1_VS_0.Instance, (uint8 **)&RecvBuffer[0]);
    }
    ...
    /* Set mode Pins for Master which uses Lpuart2 - PTA8 (RX) and PTA9 (TX) */
    /* PTA9 */
    Siul2_Port_Ip_SetOutputBuffer(PORTA_L_HALF, 9, TRUE, PORT_MUX_ALT2);
    /* PTA8 */
    Siul2_Port_Ip_SetInputBuffer(PORTA_L_HALF, 8, FALSE, 158, PORT_INPUT_MUX_ALT0);
    Siul2_Port_Ip_SetInputBuffer(PORTA_L_HALF, 8, TRUE, 189, PORT_INPUT_MUX_ALT3);

    /* Set mode Pins for Slave which uses Lpuart3 - PTD3 (RX) and PTD2 (TX) */
    Siul2_Port_Ip_SetOutputBuffer(PORTD_L_HALF, 2, TRUE, PORT_MUX_ALT6);
    Siul2_Port_Ip_SetInputBuffer(PORTD_L_HALF, 3, FALSE, 157, PORT_INPUT_MUX_ALT0);
    Siul2_Port_Ip_SetInputBuffer(PORTD_L_HALF, 3, TRUE, 32, PORT_INPUT_MUX_ALT1);
    ...
    do
    {
        LpuartMasterStatus = Lpuart_Lin_Ip_GetStatus(Lpuart_Lin_Ip_Sa_pHwConfigPB_0_VS_0.Instance, (uint8 **)&DummyBuffer);
    }
    ...
    do
    {
        LpuartSlaveStatus = Lpuart_Lin_Ip_GetStatus(Lpuart_Lin_Ip_Sa_pHwConfigPB_1_VS_0.Instance, (uint8 **)&RecvBuffer[1]);
    }
