...
#define RM_AXBS_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION     4
#define RM_AXBS_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION  0
#define RM_AXBS_IP_CFG_DEFINES_SW_MAJOR_VERSION             2
#define RM_AXBS_IP_CFG_DEFINES_SW_MINOR_VERSION             0
#define RM_AXBS_IP_CFG_DEFINES_SW_PATCH_VERSION             1
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
#define RM_CROSSBAR_PRS_READONLY                       ([!IF "ecu:get('Rm.Crossbar.PRS.IsReadOnly')"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
