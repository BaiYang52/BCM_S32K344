...
#define SENT_CFG_AR_RELEASE_MINOR_VERSION         4
#define SENT_CFG_AR_RELEASE_REVISION_VERSION      0
#define SENT_CFG_SW_MAJOR_VERSION                 2
...
*
*/
#define SENT_NUMBER_CONFIGURED_CHANNELS[!WS "4"!][!"num:i(count(SentConfigSet/SentControllerConfig/*/SentChannelConfig/*))"!]U
