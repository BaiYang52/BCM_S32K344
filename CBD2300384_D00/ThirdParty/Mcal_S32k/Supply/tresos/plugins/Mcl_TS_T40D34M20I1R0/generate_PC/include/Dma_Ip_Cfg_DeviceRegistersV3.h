...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    ...
    [!IF "contains($DerivativeName, 'S32K3')"!][!//
        [!IF "contains($DerivativeName, 'S32K341')"!][!//
            [!CODE!][!WS "0"!]#include "S32K342_DMA.h"[!CR!][!ENDCODE!][!//
            [!CODE!][!WS "0"!]#include "S32K342_DMAMUX.h"[!CR!][!ENDCODE!][!//
            [!CODE!][!WS "0"!]
        ...
        [!ENDIF!][!//
    [!ENDIF!][!//
    [!IF "contains($DerivativeName, 'S32K342') or contains($DerivativeName, 'S32K341')"!][!//
        [!CODE!]
...
/  DMAMUX CHANNELS                               /
/-----------------------------------------------*/
[!IF "contains($DerivativeName, 'S32K312')"!][!//
    [!CODE!][!WS "0"!]#define DMA_IP_DMAMUX_NOF_CHANNELS         ((uint32)(DMAMUX_CHCFG_COUNT - 2U))[!CR!][!ENDCODE!][!//
 [!ELSE!]
    [!CODE!][!WS "0"!]#define DMA_IP_DMAMUX_NOF_CHANNELS         ((uint32)DMAMUX_CHCFG_COUNT)[!CR!][!ENDCODE!][!//
[!ENDIF!]
