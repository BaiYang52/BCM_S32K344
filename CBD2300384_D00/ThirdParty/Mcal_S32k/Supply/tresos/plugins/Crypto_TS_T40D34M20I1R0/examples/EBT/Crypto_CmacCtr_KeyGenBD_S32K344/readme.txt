...
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.3 Debugger
            If EVB board 'S32K3X4EVB-Q257 47827 PCB RevX1 SCH RevA' is used, the debugger must be connected to J52 10-pin JTAG Cortex Debug connector.
            If EVB board 'S32K3XXEVB-Q172 47811 PCB RevX1 SCH RevB' is used, the debugger must be connected to J31 20-pin Cortex Debug D ETM connector.
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - ADDITIONAL_INCLUDE_DIRS The list of directories in the 'interface' folder of the HSE Firmware release that was used to test the current version of the Crypto driver.
                ...
                Ex: ADDITIONAL_INCLUDE_DIRS = C:/NXP/HSE_FW_S32K3X4_0_2_1_0/hse_full_mem/interface \
