    ...
    2.1 Hardware installation
       2.1.1 Supported boards
        ...
        2.1.2 Connections
            ...
            - The following Connections must be done for QSPI_A to work on Mini-module XS32K3X2CVB-Q172:
                - Connect J70, J402 to default position (1-2)
                - The following Resistors (R) need to be soldered:
                    | # | Resistor | Comment                 |
                    |---|----------|-------------------------|
                    | 1 | R2054    | PTD11 to QSPI_A_IO1_MCU |
                    | 2 | R491     | PTD7  to QSPI_A_IO2_MCU |
                    | 3 | R492     | PTD12 to QSPI_A_IO3_MCU |
                    | 4 | R1187    | PTC2  to QSPI_A_IO4_MCU |
                    | 5 | R1326    | PTC3  to QSPI_A_CS_MCU  |
                    | 6 | R1328    | PTD10 to QSPI_A_SCK_MCU |
        2.1.3 Debugger
