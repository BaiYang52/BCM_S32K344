...
void User_EdgeDetect0(void)
{
    ...
    {
        Siul2_Dio_Ip_WritePin(Digital_Output_LED_D79_PORT, Digital_Output_LED_D79_PIN, 1);
    }
    else
    {
        Siul2_Dio_Ip_WritePin(Digital_Output_LED_D79_PORT, Digital_Output_LED_D79_PIN, 0);
    }
}
/**
...
int main(void)
{
    ...
    Emios_Icu_Ip_EnableEdgeDetection(0,1);
    Emios_Icu_Ip_EnableNotification(0,1);
