...
void User_EdgeDetect0(void)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D79, STD_HIGH);
    }
    else
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D79, STD_LOW);
    }
}
...
void User_EdgeDetect1(void)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D76, STD_HIGH);
    }
    else
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D76, STD_LOW);
    }
}
...
void User_EdgeDetect2(void)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D80, STD_HIGH);
    }
    else
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D80, STD_LOW);
    }
}
/**
