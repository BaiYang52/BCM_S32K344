...
#define WDG_43_INSTANCE1_IPW_SW_MAJOR_VERSION_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBCFG             2
...
#error "Swt_43_Instance1_Ipw_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Wdg_Ipw_Types.h have different vendor ids"
#endif
...
#error "AutoSar Version Numbers of Swt_43_Instance1_Ipw_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Wdg_Ipw_Types.h are different"
#endif
...
#error "Software Version Numbers of Swt_43_Instance1_Ipw_[!IF "var:defined('postBuildVariant')"!][!"$postBuildVariant"!]_[!ENDIF!]PBcfg.h and Wdg_Ipw_Types.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
[!VAR "xPathModule" = "concat('ASPathDataOfSchema:/Wdg_43_Instance','1','_','TS_T40D34M20I1R0/Wdg')"!][!//
