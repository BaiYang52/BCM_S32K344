...
void I2c_Callback(uint8 u8Event, uint8 u8Channel)
{
    switch(u8Event)
    {
        case I2C_EVENT_RX_REQ_SLAVE:
            I2c_PrepareSlaveBuffer((uint8)1U, TRANSFER_SIZE, rxBufferSlave);
            break;
        
        case I2C_EVENT_TX_REQ_SLAVE:
            I2c_PrepareSlaveBuffer((uint8)1U, TRANSFER_SIZE, txBuffer);
            break;
...
void Init_Pins(void)
{
    ...
    IP_SIUL2->IMCR[212] = 1;
    /* LPI2C1_SDA - PTC 29 */
    IP_SIUL2->MSCR[93] = SIUL2_MSCR_OBE(1)|SIUL2_MSCR_IBE(1)|SIUL2_MSCR_SSS_0(1)|SIUL2_MSCR_SSS_1(1)|SIUL2_MSCR_SSS_2(1);
    IP_SIUL2->IMCR[155] = 6;



    /* LPI2C1_SCL PTC 28 */
    IP_SIUL2->MSCR[92] = SIUL2_MSCR_OBE(1)|SIUL2_MSCR_IBE(1)|SIUL2_MSCR_SSS_0(0)|SIUL2_MSCR_SSS_1(0)|SIUL2_MSCR_SSS_2(1);
    IP_SIUL2->IMCR[154] = 7;
