...
2. Installation steps
	...
	2.2.2 Connections
		Connections: SDA: J86.1(PTC9) - J80.1 SCL(PTC29): J86.2(PTC8) - J80.2(PTC28). Pull up resistors of 4.7K each, one connected between SDA(J86.2) and VDD and one connected between SCL(J86.1) and VDD
