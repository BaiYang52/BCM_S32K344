...
2. Installation steps
    2.1 Hardware installation
        ...
        2.2.2 Connections
             Connections: SCL(PTD9 - PTD14) J38.15 - J38.11     SDA (PTD8 - PTD13) J3.30 - J38.12. Pull up resistors of 4.7K each, one connected between SDA and VDD and one connected between SCL and VDD
             The register R2050 and R2051 need to be installed on miniboard
	2.2.3 Debugger
