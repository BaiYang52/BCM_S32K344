...
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.2 Connections
            J290 position 3-4 need to be wired on Motherboard.
            J281 position 1-J180 position 4 need to be wired on Motherboard.
            J617 position 1-2 need to be wired on Motherboard.
            PTA1(EMIOS_0_CH9) will control the LED(D79 on Motherboard) with the edge aligned mode, control the led brightness and blink this Led.
            PTC10(EMIOS_0_CH6) will control the LED(D78 on Motherboard) with the center aligned mode, control the led brightness and blink this Led.
        2.1.3 Debugger
