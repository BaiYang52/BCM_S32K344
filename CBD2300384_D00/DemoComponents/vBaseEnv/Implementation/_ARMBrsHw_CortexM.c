...
#endif
#if (ARMBRSHW_CORTEXM_BUGFIX_VERSION != 0x05u)
...
#if !defined (BRSHW_PLATFORM_SPECIFIC_SOFTWARERESETECU_AVAILABLE)
/*****************************************************************************/
...
void BrsHwSoftwareResetECU(void)
{
  ...
  /* set VECTRESET bit to trigger a core reset - needed on some (old) Cortex-M cores */
  BRSHW_MCORE_SCS_AIRCR = 0x05FA0001;
...
#endif /*!BRSHW_PLATFORM_SPECIFIC_SOFTWARERESETECU_AVAILABLE*/
