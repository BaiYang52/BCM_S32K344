...
namespace Vector.VTT.VsProjectGenerator
{
  class ModuleSd : IModule
  {
    ...
    public void Configure(IEcucProvider ecuc, IGeneratorModel model)
    {
      ...
      {
        string sdDir = Helper.GetModuleBSWDir(model.Directory.BSW, "Sd");
        ...
        if (System.IO.File.Exists(System.IO.Path.Combine(sdDir, "Sd_Cbk.h")))
         model.Project.AddBswFile(System.IO.Path.Combine(sdDir, "Sd_Cbk.h"), Name);
        if (System.IO.File.Exists(System.IO.Path.Combine(genDataDir, "Sd_Cbk.h")))
         model.Project.AddBswFile(System.IO.Path.Combine(genDataDir, "Sd_Cbk.h"), Name);
        if (System.IO.File.Exists(System.IO.Path.Combine(genDataDir, "SchM_Sd_Type.h")))
