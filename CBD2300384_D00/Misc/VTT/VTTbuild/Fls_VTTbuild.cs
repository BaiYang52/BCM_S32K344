...
namespace Vector.VTT.VsProjectGenerator
{
  class ModuleVTTFls : IModule
  {
    ...
    public void Configure(IEcucProvider ecuc, IGeneratorModel model)
    {
      ...
      {
        string flsDir = Helper.GetModuleBSWDir(model.Directory.BSW, "VttFls");
        ...
        model.Project.AddBswFile(System.IO.Path.Combine(genDataDir, "Fls_Lcfg.c"), moduleName);
        model.Project.AddBswFile(System.IO.Path.Combine(genDataDir, "Fls_Cfg.h"), moduleName);
