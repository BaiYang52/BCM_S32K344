...
#define BRSHW_INIT_CORE_ID  BRSHW_DERIVATIVE_CORE0_ID
  ...
  /* Reads core id value */
  #define BRS_READ_COREID(c)    "MOV " #c " , #0" " \n"  /* To be defined for MULTICORE DERIVATIVES*/
 ...
 *********************************************************************************************************************/
#if defined (BRS_COMP_IAR)
/*Declaration necessary for IAR compiler to find the symbol in ARMStartup_CortexM.c*/
