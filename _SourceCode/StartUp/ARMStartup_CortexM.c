...
#if defined (BRS_COMP_IAR)
BRS_LOCAL_PROTOTYPE(Brs_IarLoadVtorExcVectSymbols)
BRS_LOCAL_PROTOTYPE(Brs_IarLoadZeroInitBlockSymbol)
BRS_LOCAL_PROTOTYPE(Brs_IarLoadZeroInitGroupSymbol)
BRS_LOCAL_PROTOTYPE(Brs_IarLoadCoreConfigSizeSymbol)
BRS_LOCAL_PROTOTYPE(Brs_IarLoadCoreConfigSymbol)
#endif /*BRS_COMP_IAR*/

#if defined (BRS_COMP_IAR)
#pragma location = ".brsStartup"
__task void Brs_IarLoadVtorExcVectSymbols(void)
{
  /* Load constant into R1. ORR is only a helper consturct */
#if defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS)
  asm volatile ("ORRS R1, %0, %0 \n" : : "R1"(NVIC_VTOR));
  asm volatile ("ORRS R2, %0, %0 \n" : : "R2"(&intvect_CoreExceptions));
#else
  asm volatile ("ORR R1, %0, %0 \n" : : "r"(NVIC_VTOR));
  asm volatile ("ORR R2, %0, %0 \n" : : "r"(&intvect_CoreExceptions));
#endif
}

#pragma location = ".brsStartup"
__task void Brs_IarLoadZeroInitBlockSymbol(void)
{
  /* Load constant into R1. ORR is only a helper consturct */
#if defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS)
  asm volatile ("ORRS R1, %0, %0 \n" : : "r"(vLinkGen_ZeroInit_Early_Blocks) : "r0" );
#else
  asm volatile ("ORR R1, %0, %0 \n" : : "r"(vLinkGen_ZeroInit_Early_Blocks) : "r0" );
#endif
}
...
#pragma location = ".brsStartup"
__task void Brs_IarLoadZeroInitGroupSymbol(void)
{
  /* Load constant into R1. ORR is only a helper consturct */
#if defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS)
  asm volatile ("ORRS R1, %0, %0 \n" : : "r"(vLinkGen_ZeroInit_Early_Groups) : "r0" );
#else
  asm volatile ("ORR R1, %0, %0 \n" : : "r"(vLinkGen_ZeroInit_Early_Groups) : "r0" );
#endif
}
...
#pragma location = ".brsStartup"
__task void Brs_IarLoadCoreConfigSizeSymbol(void)
{
  /* Load constant into R1. ORR is only a helper consturct */
#if defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS)
  asm volatile ("ORRS R1, %0, %0 \n" : : "r"(&BrsMain_CoreConfig_Size) : "r0" );
#else
  asm volatile ("ORR R1, %0, %0 \n" : : "r"(&BrsMain_CoreConfig_Size) : "r0" );
#endif
}
...
#pragma location = ".brsStartup"
__task void Brs_IarLoadCoreConfigSymbol(void)
{
  /* Load constant into R1. ORR is only a helper consturct */
#if defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS)
  asm volatile ("ORRS R1, %0, %0 \n" : : "r"(BrsMain_CoreConfig) : "r0" );
#else
  asm volatile ("ORR R1, %0, %0 \n" : : "r"(BrsMain_CoreConfig) : "r0" );
#endif
}
...
# if defined (BRS_COMP_IAR)
/*This instruction is necessary for IAR compiler to find the symbol in BrsHw.c*/
__as1(LDR R0, =brsPreAsmStartupHook)
# endif
#endif
...
#if defined (BRS_COMP_IAR)
 BRS_BRANCH_LINK(Brs_IarLoadVtorExcVectSymbols)
...
#  if defined (BRS_COMP_IAR)
 BRS_BRANCH_LINK(Brs_IarLoadZeroInitBlockSymbol)
#  else
...
#   if (defined (BRS_COMP_IAR) ) && (defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS))
 __as2(ADDS  R1, R1, #16)
#   else
 __as2(ADD  R1, R1, #16)
#   endif
...
#  if (defined (BRS_COMP_IAR) ) && (defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS))
  __as2(ORRS  R7, R7, R3) /* Or with vLinkGen_ZeroInit_Early_Blocks->start */
  __as2(ORRS  R7, R7, R4) /* Or with vLinkGen_ZeroInit_Early_Blocks->end */
  __as2(ORRS  R7, R7, R5) /* Or with vLinkGen_ZeroInit_Early_Blocks->core */
#  else
...
#   if (defined (BRS_COMP_IAR) ) && (defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS))
 __as2(ADDS  R3, R3, #4) /* increase address value of R3 by '4' */
#   else
...
#  if defined (BRS_COMP_IAR)
 BRS_BRANCH_LINK(Brs_IarLoadZeroInitGroupSymbol)
#  else
...
#  if (defined (BRS_COMP_IAR) ) && (defined (BRS_CPU_CORE_CORTEX_M0) || defined (BRS_CPU_CORE_CORTEX_M0PLUS))
  __as2(ORRS  R7, R7, R3) /* Or with vLinkGen_ZeroInit_Early_Groups->start */
  __as2(ORRS  R7, R7, R4) /* Or with vLinkGen_ZeroInit_Early_Groups->end */
  __as2(ORRS  R7, R7, R5) /* Or with vLinkGen_ZeroInit_Early_Groups->core */
#  else
...
# if defined (BRS_COMP_IAR)
 BRS_BRANCH_LINK(Brs_IarLoadCoreConfigSizeSymbol)
# else
...
# if defined (BRS_COMP_IAR)
 BRS_BRANCH_LINK(Brs_IarLoadCoreConfigSymbol)
# else
